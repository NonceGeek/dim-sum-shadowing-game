const category = [
  {
    ...
    questions: [
      {
        content: "我(ngo5)唔(m4)食(sik6)辣(laat6)嘢(je5)",
  ...
  },
  {
    ...
    questions: [
      {
        content: "依(ji1)个(go3)地(dei6)址(zi2)点(dim2)行(haang4)",
  ...
  },
  {
    ...
    questions: [
      {
        content:
          "广(gwong2)州(zau1)灯(dang1)光(gwong1)秀(sau3)型(jing4)到(dou3)爆(baau3)",
  ...
  },
  {
    ...
    questions: [
      {
        content:
          "去(heoi3)广(gwong2)州(zau1)塔(taap3)大(daai6)概(koi3)要(jiu3)几(gei1)耐(noi6)",
        originalText: "去广州塔大概要多久？",
        yueText: "去广州塔大概要几耐",
